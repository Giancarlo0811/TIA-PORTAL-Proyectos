...
## 📋 Descripción
Control de Nivel de un Tanque de agua, para el llenado y vaciado automático y manual del tanque.

## 🎯 Objetivos del Proyecto
- Implementar lógica de control secuencial
- Gestionar modos de operación (Auto/Manual)
- Simular comportamiento en tiempo real
